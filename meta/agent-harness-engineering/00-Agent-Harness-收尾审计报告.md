...
| P1 | 给第 1、3、4、6、7 篇补小图或状态表 | 已于 2026-07-07 补充 |
| P1 | 给第 5、8 篇补一个最小运行记录 | 已于 2026-07-07 补充 |
| P2 | 统一每篇“动手实验”标题和 AHE 编号写法 | 已于 2026-07-07 补充 |
| P2 | 做一次官方链接和日期复核 | 已于 2026-07-07 补充 |

下一阶段建议：先做 P1 小幅打磨，不新增第三条学习方向。等这组文章达到“可发布版本”后，再考虑开 OpenAI Agents SDK、LangGraph、SWE-agent 或 MCP server 设计的新 track。

## 七、2026-07-07 打磨记录

本轮没有改变系列结构，也没有新增第 9 篇文章，只按审计报告做小幅加深：

| 文章 | 补充内容 | 对应审计项 |
| --- | --- | --- |
| 第 1 篇 | Agent Loop 状态表 | P1 小图或状态表 |
| 第 2 篇 | MCP 过渡明确指向第 8 篇 | P1 结构收束 |
| 第 3 篇 | allow / ask / deny 决策表 | P1 小图或状态表 |
| 第 4 篇 | hook 失败策略表 | P1 小图或状态表 |
| 第 5 篇 | compact / memory 最小观察记录 | P1 运行记录 |
| 第 6 篇 | 失败恢复状态机表 | P1 小图或状态表 |
| 第 7 篇 | Lead / teammate 消息时序表 | P1 小图或状态表 |
| 第 8 篇 | mock MCP server 最小运行记录 | P1 运行记录 |

官方链接复核已于 2026-07-07 完成。本轮只更新 Agent Harness 系列文章的官方文档核查日期，不更新社区项目核查日期，因为本轮没有重新读取 `shareAI-lab/learn-claude-code` 的远程章节文件。
